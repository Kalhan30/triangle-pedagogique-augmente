export const FAQ_ENTRIES = [
  ...
  },
  {
    ...
    reponse: "Oui, sous supervision enseignante. Les P2IA (Partenariat d'innovation en intelligence artificielle) sont issus d'un marché public innovant porté par le Ministère de l'Éducation nationale, le Secrétariat général pour l'investissement (France 2030) et la Banque des Territoires, développés par des entreprises EdTech en collaboration avec des laboratoires de recherche. Cinq services sont déployés pour le cycle 2 depuis 2020 : Lalilo et Navi en français, Adaptiv'Math, Mathia et Smart Enseigno en mathématiques. À la différence des IA génératives ouvertes, ces outils fonctionnent dans un cadre juridique et éthique strict, sans saisie de données personnelles d'élèves dans des services grand public. Pour le cycle 3 (CM1, CM2, 6ᵉ), six nouveaux services sont en phase d'expérimentation depuis janvier 2026 dans des classes volontaires sélectionnées : Expliq, Edumalin, Mathia-C3, Origamia, Cards (langues vivantes), yLANG (langues vivantes). Sources : Eduscol, Primàbord, DRANE Occitanie.",
  },
  {
    id: 'faq-2',
    ordre: 2,
