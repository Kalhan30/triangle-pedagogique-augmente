  ...
  return (
    <main className="min-h-screen bg-background animate-fade">
      <div className="max-w-[720px] mx-auto px-6 md:px-12 py-10">
        ...
        <p className="text-base text-text-emphasized leading-[1.7] mb-8">
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">À quoi sert cet outil</h2>
          <p className="text-base text-text-emphasized leading-[1.7] mb-4">
          ...
          <p className="text-base text-text-emphasized leading-[1.7]">
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Le statut de cet outil</h2>
          <div
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Ce que vous pouvez en attendre</h2>
          <ul className="space-y-3 text-base text-text-emphasized leading-[1.7] pl-2">
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Ce que cet outil ne remplace pas</h2>
          <ul className="space-y-3 text-base text-text-emphasized leading-[1.7] pl-2">
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Contribuer</h2>
          <p className="text-base text-text-emphasized leading-[1.7] mb-5">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            <button
              onClick={onRetour}
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-brand-teal text-background font-semibold hover:bg-brand-teal-light transition"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-brand-teal-light hover:text-brand-teal transition hover:underline underline-offset-4"
            >
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Sources et références</h2>
          <ul className="space-y-4 text-sm text-text-emphasized leading-[1.7]">
            ...
            <li>
              ...
              <a href={mentionCfg.cadreUrl} target="_blank" rel="noopener noreferrer" className="text-brand-teal-light hover:underline inline-flex items-center gap-1">
        ...
        <section>
          <h2 className="text-[22px] font-semibold text-brand-teal-light mt-10 mb-4">Version et crédits</h2>
          <div className="text-sm text-text-emphasized leading-[1.8] space-y-1">
            <p>Version actuelle : {mentionCfg.version}</p>
            <p>Conception, développement et maintenance : {mentionCfg.auteure}</p>
            <p>Contact : via le blog <a href={mentionCfg.blogUrl} target="_blank" rel="noopener noreferrer" className="text-brand-teal-light hover:underline">{mentionCfg.marque}</a></p>
          </div>
        </section>
      </div>
    </main>
