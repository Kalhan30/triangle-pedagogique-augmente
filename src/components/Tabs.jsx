...
export default function Tabs() {
  ...
  return (
    <nav className="border-b border-background-elevated">
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 text-sm font-medium whitespace-nowrap border-b-2 transition ${
                active
                  ? 'border-brand-teal text-brand-teal-light'
                  : 'border-transparent text-text-secondary hover:text-text hover:border-background-elevated'
              }`}
